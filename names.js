...
var names = {
    combined: _.flatten(_.map(names1, function(v, i) { return [v, names2[i]]; })),
    get: function() {
        if(Memory.creep_index == undefined || Memory.creep_index >= this.combined.length) {
            Memory.creep_index = 0;
        } else {
            Memory.creep_index++;
        }
        return this.combined[Memory.creep_index];
    }
}
